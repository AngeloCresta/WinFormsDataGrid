...
namespace System.Windows.Forms
{
    ...
    using System.Windows.Forms.Legacy;
    ...
    internal abstract class DataGridRow : MarshalByRefObject
    {
        ...
        public DataGridRow(DataGrid dataGrid, DataGridTableStyle dgTable, int rowNumber)
        {
            ...
            if (rowNumber < 0)
                throw new ArgumentException("DataGridRowRowNumber " + rowNumber);
        ...
        */
        ...
        protected Bitmap GetBitmap(string bitmapName)
        {
            ...
            string resource = bitmapName.Replace((".bmp").ToLower(),string.Empty);
            resource = resource.Replace((".").ToLower(), "_");
            ResourceManager rm = System.Windows.Forms.Legacy.Properties.Resource.ResourceManager;

            try
            {
                b = (Bitmap)rm.GetObject(resource);
        ...
        public virtual void PaintHeader(Graphics g, Rectangle visualBounds, bool alignToRight, bool rowIsDirty)
        {
            ...
            g.FillRectangle(this.DataGrid.GridLineBrush, new Rectangle(visualBounds.X - 1, visualBounds.Y - 1, visualBounds.Width + 2, visualBounds.Height + 2));
            ...
            //
            object errorInfo = DataGrid.ListManager.GetByID(this.number);
