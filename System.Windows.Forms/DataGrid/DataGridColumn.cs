...
namespace System.Windows.Forms
{
    ...
    public abstract class DataGridColumnStyle : Component, IDataGridColumnStyleEditingNotificationService
    {
        ...
        private string nullText = "DataGridNullText";
        ...
        public virtual HorizontalAlignment Alignment
        {
            ...
            set
            {
                ...
                if (!IsEnumValid(value, (int)value, (int)HorizontalAlignment.Left, (int)HorizontalAlignment.Center))
                {
...
*/
        ...
        */
        ...
        /// </devdoc>
        [
        Editor("System.Windows.Forms.Design.DataGridColumnStyleMappingNameEditor, " + AssemblyRefEx.SystemDesign, typeof(System.Drawing.Design.UITypeEditor)),
        Localizable(true),
        DefaultValue("")
        ]
        ...
        protected internal virtual object GetColumnValueAtRow(CurrencyManager source, int rowNum)
        {
            ...
            {
                throw new InvalidOperationException("DataGridColumnNoPropertyDescriptor");
            }
            object value = PropertyDescriptor.GetValue(source.GetByID(rowNum));
            return value;
        }
        ...
        protected void CheckValidDataSource(CurrencyManager value)
        {
            ...
            if (myPropDesc == null)
            {
                throw new InvalidOperationException("DataGridColumnUnbound - HeaderText");
            }
        ...
        protected internal virtual void SetColumnValueAtRow(CurrencyManager source, int rowNum, object value)
        {
            ...
            if (source.Position != rowNum)
                throw new ArgumentException("DataGridColumnListManagerPosition - " +rowNum);
            if (source.GetByID(rowNum) is IEditableObject)
                ((IEditableObject)source.GetByID(rowNum)).BeginEdit();
            this.PropertyDescriptor.SetValue(source.GetByID(rowNum), value);
        }
