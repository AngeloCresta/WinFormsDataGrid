    ...
    internal class DataGridCaption
    {
        ...
        internal Color BackColor
        {
            ...
            set
            {
                ...
                {
                    if (value.IsEmpty)
                        throw new ArgumentException("DataGridEmptyColor - Caption BackColor");
        ...
        internal Color ForeColor
        {
            ...
            {
                if (value.IsEmpty)
                    throw new ArgumentException("DataGridEmptyColor - Caption ForeColor");
        ...
        internal Rectangle GetBackButtonRect(Rectangle bounds, bool alignRight, int downButtonWidth)
        {
            ...
            Size backButtonSize = new Size(12,12);
        ...
        {
            Size downButtonSize = new Size(12, 12);
            Bitmap detailsBmp = GetDetailsBmp();
