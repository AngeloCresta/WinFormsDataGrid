...
namespace System.Windows.Forms {
    ...
    public class DataGridTableStyle : Component, IDataGridEditingService {
        ...
        public bool AllowSorting {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException("AllowSorting");
                }
        ...
        public Color ForeColor {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException("ForeColor");
                }
        ...
        public Color GridLineColor {
            ...
            set {
                    if (this.isDefaultTableStyle) {
                        throw new ArgumentException("GridLineColor");
                }
        ...
        public DataGridLineStyle GridLineStyle {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException("GridLineStyle");
                }
        ...
        public Font HeaderFont {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException("HeaderFont");
                }
...
;
        ...
        public int PreferredRowHeight {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException("PrefferedRowHeight");
                }
	...
	private void ResetPreferredRowHeight() {
        ...
        public Color SelectionForeColor {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException("SelectionForeColor");
                }
