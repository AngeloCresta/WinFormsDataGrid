...
namespace System.Windows.Forms
{
    ...
    public class DataGrid : Control, ISupportInitialize, IDataGridEditingService
    {
        ...
        // these are actually get/set by ColumnBehaviour
        ...
        /// </devdoc>
        [
        Category(ModernDefaults.PropertyCategory.Behaviour),
        DefaultValue(true)
        ]
        ...
        public Color AlternatingBackColor
        {
            ...
            set
            {
                ...
                if (IsTransparentColor(value))
                    throw new ArgumentException("DataGridTransparentAlternatingBackColorNotAllowed");
        ...
        public override Color BackColor
        {
            ...
            {
                if (IsTransparentColor(value))
                    throw new ArgumentException("DataGridTransparentBackColorNotAllowed");
        ...
        /// </devdoc>
        [
        Category(ModernDefaults.PropertyCategory.Appearance),
        ...
        public BorderStyle BorderStyle
        {
            ...
            set
            {
                ...
                if (!IsEnumValid(value, (int)value, (int)BorderStyle.None, (int)BorderStyle.Fixed3D))
                {
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [Category(ModernDefaults.PropertyCategory.PropertyChanged)]
        ...
        public Color CaptionBackColor
        {
            ...
            {
                if (IsTransparentColor(value))
                    throw new ArgumentException("DataGridTransparentCaptionBackColorNotAllowed");
        ...
        [
         DefaultValue(true),
         Category(ModernDefaults.PropertyCategory.Display)
        ]
        ...
        public DataGridCell CurrentCell
        {
            ...
            set
            {
                ...
                if (layout.dirty)
                    throw new ArgumentException("DataGridSettingCurrentCellNotGood");
                ...
                {
                    DialogResult result = MessageBox.Show(null, errorMessage,
                        "DataGridErrorMessageBoxCaption", MessageBoxButtons.YesNo,
        ...
        public Color SelectionBackColor
        {
            ...
            {
                if (value.IsEmpty)
                    throw new ArgumentException("DataGridEmptyColor");
                if (IsTransparentColor(value))
                    throw new ArgumentException("DataGridTransparentSelectionBackColorNotAllowed");
        ...
        private void ResetToolTip()
        {
            ...
            if (!this.parentRows.IsEmpty())
            {
                ...
                ToolTipProvider.AddToolTip("Back", new IntPtr(0), backButton);
                ToolTipProvider.AddToolTip("Details", new IntPtr(1), detailsButton);
                ToolTipId = 2;
            }
            else
            {
        ...
        [
         DefaultValue(null),
         Category(ModernDefaults.PropertyCategory.Data),
        ...
        [
         DefaultValue(null),
         Category(ModernDefaults.PropertyCategory.Data),
         Editor("System.Windows.Forms.Design.DataMemberListEditor, " + ModernUI.Local.Common.AssemblyRefEx.SystemDesign, typeof(System.Drawing.Design.UITypeEditor))
        ]
        ...
        public int CurrentRowIndex
        {
            ...
            {
                if (this.listManager == null)
                    throw new InvalidOperationException("DataGridSetSelectIndex");
        ...
        public DataGridLineStyle GridLineStyle
        {
            ...
            set
            {
                ...
                if (!IsEnumValid(value, (int)value, (int)DataGridLineStyle.None, (int)DataGridLineStyle.Solid))
                {
        ...
        public DataGridParentRowsLabelStyle ParentRowsLabelStyle
        {
            ...
            set
            {
                ...
                if (!IsEnumValid(value, (int)value, (int)DataGridParentRowsLabelStyle.None, (int)DataGridParentRowsLabelStyle.Both))
                {
        ...
        public Color HeaderBackColor
        {
            ...
            set
            {
                ...
                if (IsTransparentColor(value))
                    throw new ArgumentException("DataGridTransparentHeaderBackColorNotAllowed");
        ...
        public Color HeaderForeColor
        {
            ...
            {
                if (value.IsEmpty)
                    throw new ArgumentException("HeaderForeColor");
        ...
        public Color LinkColor
        {
            ...
            {
                if (value.IsEmpty)
                    throw new ArgumentException("LinkColor");
        ...
        public Color ParentRowsBackColor
        {
            ...
            {
                if (IsTransparentColor(value))
                    throw new ArgumentException("DataGridTransparentParentRowsBackColorNotAllowed");
        ...
        [
         ...
         Category(ModernDefaults.PropertyCategory.Layout),
        ...
        public int PreferredColumnWidth
        {
            ...
            {
                if (value < 0)
                    throw new ArgumentException("PreferredColumnWidth");
        ...
        public int PreferredRowHeight
        {
            ...
            {
                if (value < 0)
                    throw new ArgumentException("DataGridRowRowHeight");
        ...
        private bool DataGridSourceHasErrors()
        {
            ...
            {
                object errObj = this.listManager.GetByID(i);
        ...
        private void DataSource_ItemChanged(object sender, ItemChangedEventArgs ea)
        {
            ...
            else
            {
                ...
                object errObj = this.listManager.GetByID(ea.Index);
                bool oldListHasErrors = ListHasErrors;
                if (errObj is IDataErrorInfo)
                {
        ...
        */
        ...
        ///    </para>
        /// </devdoc>
        public virtual void GridHScrolled(object sender, ScrollEventArgs se)
        {
            if (!Enabled)
                return;
            if (DataSource == null)
        ...
        private void HandleEndCurrentEdit()
        {
            ...
            if (errorMessage != null)
            {
                DialogResult result = MessageBox.Show(null, errorMessage, "DataGridErrorMessageBoxCaption", MessageBoxButtons.YesNo,
                        MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, 0);
        ...
        protected override void OnBindingContextChanged(EventArgs e)
        {
            if (this.DataSource != null && !gridState[GRIDSTATE_inSetListManager])
                ...
                catch
                {
                    ...
                    MessageBox.Show(null, "DataGridExceptionInPaint", null,
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            catch
            {
                ...
                try
                {
                    MessageBox.Show(null, "DataGridExceptionInPaint", null, MessageBoxButtons.OK,
                        MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, 0);
        ...
        {
            if (inInit)
                throw new InvalidOperationException("DataGridBeginInit");
            inInit = true;
        }
        ...
        private void ColResizeBegin(MouseEventArgs e, int col)
        {
            ...
            Cursor.SetClipInternal(RectangleToScreen(clip));
        ...
        private void ColResizeEnd(MouseEventArgs e)
        {
            ...
            {
                Cursor.SetClipInternal(Rectangle.Empty);
        ...
        private void EnsureBound()
        {
            if (!Bound)
            {
                throw new InvalidOperationException("DataGridUnbound");
            }
        }
        ...
        private void PaintColumnHeaders(Graphics g)
        {
            ...
            else
            {
                ...
                using (Pen p = new Pen(GridLineColor))
                    g.DrawRectangle(p, boundingRect);
            }
        }
        ...
        private int PaintColumnHeaderText(Graphics g, Rectangle boundingRect)
        {
            ...
            for (int col = firstVisibleCol; col < nGridCols; ++col)
            {
                ...
                if (columnSorted)
                {
                    ...
                    Pen pen2 = new Pen(this.BackgroundBrush);// this.myGridTable.BackBrush);
        ...
        private void PaintGrid(Graphics g, Rectangle gridBounds)
        {
            ...
            if (this.listManager != null)
            {
                ...
                if (layout.TopLeftHeader.Width > 0)
                {
                    ...
                    {
                        using (Pen p = new Pen(GridLineColor))
                            g.DrawRectangle(p, layout.TopLeftHeader);
                    }
                }
        ...
        internal class DataGridAccessibleObject : ControlAccessibleObject
        {
            ...
            public override AccessibleObject Navigate(AccessibleNavigation navdir)
            {
                ...
                return null;    // Perform default Behaviour
            }
        }
        ...
        #region "   Added From Legacy Controls   "
        ...
        public System.Drawing.Graphics CreateGraphicsInternal()
        {
